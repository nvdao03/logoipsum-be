export const AUTH_MESSAGE = {
  ...
  SIGN_IN_FAILED: 'Đăng nhập thất bại, vui lòng kiểm tra lại thông tin',
  ...
  SIGN_UP_SUCCESS: 'Đăng ký thành công, vui lòng kiểm tra email để kích hoạt tài khoản',
  SIGN_IN_SUCCESS: 'Đăng nhập thành công',
